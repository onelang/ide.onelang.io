(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Tokenizer", "./Parser"], factory);
    }
        ...
        static exprToAst(code) {
            ...
            for (let ptoken of parsedTokens) {
                if (ptoken.value === "[") {
                    ...
                    tokens.push(new Parser_1.Token(Parser_1.TokenType.Operator, new Parser_1.OperatorData("[", null, Parser_1.OperatorType.LeftParenthesis)));
                }
                else if (ptoken.value === "]") {
                    tokens.push(new Parser_1.Token(Parser_1.TokenType.Operator, new Parser_1.OperatorData("]", null, Parser_1.OperatorType.RightParenthesis)));
                }
                else {
                    var token;

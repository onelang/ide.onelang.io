    ...
    class Template {
        ...
        exprToJS(ast, vars, isMember) {
            if (ast.type === Parser_1.AstNodeType.Identifier) {
                ...
                return ast.operands.reduce((prev, curr) => `${prev}${curr.operator ? curr.operator.text : ""}${this.exprToJS(curr.operand, vars, curr.operator && curr.operator.text === ".")}`, "");
